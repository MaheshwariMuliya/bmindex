            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    buildSimpleButton(context, Icons.bar_chart, 'Deadlift', const Deadlift()),
                    const SizedBox(height: 20),
                    buildSimpleButton(context, Icons.accessibility_new, 'Hyperextension', const Hyperextension()),
                  ],
                ),
              ),
            ),
