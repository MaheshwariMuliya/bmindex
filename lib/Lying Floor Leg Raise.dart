...
class LyingFloorLegRaise extends StatelessWidget {
  const LyingFloorLegRaise ({super.key});
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    buildInstructionStep('1. Lay supine in a relaxed position with your legs straight and your hands underneath your low back for support.'),
                    buildInstructionStep('2. Keep your legs straight and raise them towards your forehead while contracting your abdominals and exhaling.'),
                    buildInstructionStep('3. Once your abs are fully contracted and your legs are slightly above parallel, slowly lower your legs back to the starting position.'),
