            ...
            child: Container(
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [Color.fromARGB(255, 244, 244, 247),Colors.blue],
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    buildExerciseDetail('Mechanics:', 'Beginner'),
                   ...
                   const SizedBox(height: 20),
                    ...
                    const SizedBox(height: 10),
                    buildInstructionStep(' 1. Your back must remain straight at all times. Your torso should be kept still throughout the entire set.'),
                    buildInstructionStep(' 2. Don\'t let your shoulders hunch over when your arms are extended.'),
                    buildInstructionStep('3. Use the back muscles to move the weight - do not lean forward and use momentum to swing the weight back.'),
                    buildInstructionStep(' 4. Pausing and squeezing at the top of the movement for a 1-2 count will increase intensity and results.'),
                    ],
                ),
              ),
            ),
