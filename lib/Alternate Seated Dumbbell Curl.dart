...
class AlternateSeatedDumbbellCurl extends StatelessWidget {
  const AlternateSeatedDumbbellCurl ({super.key});
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    buildExerciseDetail('Secondary Muscle(s):', 'Traps, Triceps'),
                    const SizedBox(height: 20),
                    const Text(
                    ...
                    buildInstructionStep('4. Once the dumbbells are in place, rotate your palms so they are facing forward.'),
                    buildInstructionStep('5. Take a deep breath then press the one dumbbell overhead by extending the elbow and contracting the deltoid. '),
                    buildInstructionStep('6. Slowly lower the dumbbells back to the starting position and then press the other overhead by repeating step #5 7. Repeat for the desired number of repetitions.'),
