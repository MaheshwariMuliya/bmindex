...
class FlatBenchPress extends StatelessWidget {
  const FlatBenchPress ({super.key});
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    buildTip('1. Set your feet firmly under the bench'),
                    buildTip('2. Squeeze your shoulder blades as you lower the weight down.'),
                    buildTip('3. Lower the weight until the barbell or dumbbells are and inch from your chest.'),
                    buildTip('4. Explode the weight upwards and extend the weight until your shoulders are locked out.'),
                    ],
                ),
              ),
            ),
