...
class FloorCrunch extends StatelessWidget {
  const FloorCrunch ({super.key});
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    buildInstructionStep('3. Touch the side of your head with your fingertips.'),
                   ...
                   const SizedBox(height: 20),
                    ...
                    const SizedBox(height: 10),
                    buildInstructionStep('1. Keep your shoulder blades just off the mat for the entire set.'),
                    buildInstructionStep('2. Pause for longer at the top of the movement to add extra intensity.'),
                    ],
                ),
              ),
            ),
