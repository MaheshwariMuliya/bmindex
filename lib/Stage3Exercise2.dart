...
class Stage3Exercise2 extends StatelessWidget {
  const Stage3Exercise2 ({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildGradientButton(context, Icons.fitness_center, 'Bench Press', const BenchPress(),
                        [const Color.fromARGB(255, 206, 203, 203), const Color(0xFF1A1A2E)]),
                    const SizedBox(height: 20),
                    buildGradientButton(context, Icons.self_improvement, 'Barbell Row', const BarbellRow(),
                        [const Color(0xFF1A1A2E), const Color.fromARGB(255, 206, 203, 203)]),
                    const SizedBox(height: 20),
