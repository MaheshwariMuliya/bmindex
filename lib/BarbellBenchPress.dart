...
class Barbellbenchpress extends StatelessWidget {
  const Barbellbenchpress ({super.key});
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    buildTip(' 2. Keep the bar in line with your wrist and elbows and ensure it travels in a straight line. In order to keep the wrist straight, try to position the bar as low in the palm as possible while still being able to wrap the thumb.'),
